...
EventScript_MoveMrBrineyToHouse::
	setflag FLAG_TM_THUNDERBOLT_BUYABLE
	setflag FLAG_TM_SLUDGE_BOMB_BUYABLE
	setflag FLAG_TM_SCALD_BUYABLE
	setflag FLAG_TM_DUAL_WINGBEAT_BUYABLE
	clearflag FLAG_TM_MEGA_DRAIN_BUYABLE
	clearflag FLAG_TM_ICE_BEAM_BUYABLE
...
EventScript_MoveMrBrineyToDewford::
	setflag FLAG_TM_SCALD_BUYABLE
	setflag FLAG_TM_DUAL_WINGBEAT_BUYABLE
	setflag FLAG_TM_FLAMETHROWER_BUYABLE
	setflag FLAG_TM_MEGA_DRAIN_BUYABLE
	setflag FLAG_TM_ICE_BEAM_BUYABLE
	setflag FLAG_HIDE_BRINEYS_HOUSE_PEEKO
	clearflag FLAG_TM_THUNDERBOLT_BUYABLE
	clearflag FLAG_TM_SLUDGE_BOMB_BUYABLE
	end
...
EventScript_MoveMrBrineyToRoute109::
	...
	setflag FLAG_TM_THUNDERBOLT_BUYABLE
	setflag FLAG_TM_SLUDGE_BOMB_BUYABLE
	clearflag FLAG_TM_SCALD_BUYABLE
	clearflag FLAG_TM_DUAL_WINGBEAT_BUYABLE
	end
...
Common_EventScript_UpdateBrineyLocation::
	...
	goto_if_unset FLAG_TM_MEGA_DRAIN_BUYABLE, EventScript_SetBrineyLocation_House
	goto_if_unset FLAG_TM_THUNDERBOLT_BUYABLE, EventScript_SetBrineyLocation_Dewford
	goto_if_unset FLAG_TM_SCALD_BUYABLE, EventScript_SetBrineyLocation_Route109
	return
...
EventScript_PalletTown_PlayersHouse_2F_TurnOnPC::
	...
	.include "data/maps/Hoenn1_1/scripts.inc"

	.include "data/maps/Hoenn1_2/scripts.inc"

	.include "data/maps/Hoenn1_3/scripts.inc"

	.include "data/maps/Hoenn1_4/scripts.inc"

	.include "data/maps/Hoenn1_5/scripts.inc"

	.include "data/maps/Hoenn1_6/scripts.inc"

	.include "data/maps/Hoenn1_7/scripts.inc"

	.include "data/maps/Hoenn1_8/scripts.inc"
