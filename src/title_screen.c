...
static const u32 sTitleScreenRayquazaGfx[] = INCBIN_U32("graphics/title_screen/TitleScreenn.4bpp.smol");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/TitleScreenn.bin.smolTM");
...
void CB2_InitTitleScreen(void)
{
    ...
    case 2:
    {
        u8 taskId = CreateTask(Task_TitleScreenPhase2, 0);

        // Skip the logo-intro phase and jump straight to the full title-screen layout.
