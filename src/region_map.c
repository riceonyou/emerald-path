...
static u8 GetMapsecType(mapsec_u16_t mapSecId)
{
    ...
    case MAPSEC_LITTLEROOT_TOWN:
        return FlagGet(FLAG_ITEM_FERALIGITE_UNLOCKED) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_OLDALE_TOWN:
        return FlagGet(FLAG_ITEM_SKARMORITE_UNLOCKED) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_DEWFORD_TOWN:
        return FlagGet(FLAG_ITEM_FROSLASSITE_UNLOCKED) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_LAVARIDGE_TOWN:
        return FlagGet(FLAG_ITEM_EMBOARITE_UNLOCKED) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_FALLARBOR_TOWN:
        return FlagGet(FLAG_ITEM_EXCADRITE_UNLOCKED) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_VERDANTURF_TOWN:
        return FlagGet(FLAG_ITEM_SCOLIPITE_UNLOCKED) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_PACIFIDLOG_TOWN:
        return FlagGet(FLAG_ITEM_SCRAFTINITE_UNLOCKED) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_PETALBURG_CITY:
        return FlagGet(FLAG_ITEM_EELEKTROSSITE_UNLOCKED) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SLATEPORT_CITY:
        return FlagGet(FLAG_ITEM_CHANDELURITE_UNLOCKED) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_MAUVILLE_CITY:
        return FlagGet(FLAG_ITEM_CHESNAUGHTITE_UNLOCKED) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_RUSTBORO_CITY:
        return FlagGet(FLAG_ITEM_DELPHOXITE_UNLOCKED) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_FORTREE_CITY:
        return FlagGet(FLAG_ITEM_GRENINJITE_UNLOCKED) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_LILYCOVE_CITY:
        return FlagGet(FLAG_ITEM_PYROARITE_UNLOCKED) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_MOSSDEEP_CITY:
        return FlagGet(FLAG_ITEM_MALAMARITE_UNLOCKED) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SOOTOPOLIS_CITY:
        return FlagGet(FLAG_ITEM_BARBARACITE_UNLOCKED) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_EVER_GRANDE_CITY:
        return FlagGet(FLAG_ITEM_DRAGALGITE_UNLOCKED) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
{
    {
        ...
        .flag = FLAG_ITEM_FERALIGITE_BUYABLE,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_OLDALE_TOWN,
        .flag = FLAG_ITEM_SKARMORITE_BUYABLE,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_DEWFORD_TOWN,
        .flag = FLAG_ITEM_FROSLASSITE_BUYABLE,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_LAVARIDGE_TOWN,
        .flag = FLAG_ITEM_EMBOARITE_BUYABLE,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_FALLARBOR_TOWN,
        .flag = FLAG_ITEM_EXCADRITE_BUYABLE,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_VERDANTURF_TOWN,
        .flag = FLAG_ITEM_SCOLIPITE_BUYABLE,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_PACIFIDLOG_TOWN,
        .flag = FLAG_ITEM_SCRAFTINITE_BUYABLE,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_PETALBURG_CITY,
        .flag = FLAG_ITEM_EELEKTROSSITE_BUYABLE,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_SLATEPORT_CITY,
        .flag = FLAG_ITEM_CHANDELURITE_BUYABLE,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_MAUVILLE_CITY,
        .flag = FLAG_ITEM_CHESNAUGHTITE_BUYABLE,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_RUSTBORO_CITY,
        .flag = FLAG_ITEM_DELPHOXITE_BUYABLE,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_FORTREE_CITY,
        .flag = FLAG_ITEM_GRENINJITE_BUYABLE,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_LILYCOVE_CITY,
        .flag = FLAG_ITEM_PYROARITE_BUYABLE,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_MOSSDEEP_CITY,
        .flag = FLAG_ITEM_MALAMARITE_BUYABLE,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_SOOTOPOLIS_CITY,
        .flag = FLAG_ITEM_BARBARACITE_BUYABLE,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
        .mapsec = MAPSEC_EVER_GRANDE_CITY,
        .flag = FLAG_ITEM_DRAGALGITE_BUYABLE,
    },
    {
