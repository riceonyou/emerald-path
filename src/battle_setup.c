...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_SANDSLASH, TRAINER_WIGGLYTUFF, TRAINER_SLAKING, TRAINER_GOLDUCK, TRAINER_WOBBUFFET, MAP_ROUTE118),
    [REMATCH_ANDRES] = REMATCH(TRAINER_ANDRES_1, TRAINER_ANDRES_2, TRAINER_ANDRES_3, TRAINER_ANDRES_4, TRAINER_ANDRES_5, MAP_ROUTE105),
    [REMATCH_DUSTY] = REMATCH(TRAINER_XATU, TRAINER_STARMIE, TRAINER_FARIGIRAF, TRAINER_HERACROSS, TRAINER_PINSIR, MAP_ROUTE111),
    [REMATCH_LOLA] = REMATCH(TRAINER_MEGASALAMENCE, TRAINER_SPINDA, TRAINER_NINETALES, TRAINER_SOLROCKLUNATONE, TRAINER_LINOONE, MAP_ROUTE109),
    [REMATCH_RICKY] = REMATCH(TRAINER_LUDICOLO, TRAINER_GROVYLE, TRAINER_SCEPTILE, TRAINER_MEGASCEPTILE, TRAINER_TORCHIC, MAP_ROUTE109),
    ...
    [REMATCH_EDWIN] = REMATCH(TRAINER_PELIPPERWIN_1, TRAINER_PELIPPERWIN_2, TRAINER_PELIPPERWIN_3, TRAINER_PELIPPERWIN_4, TRAINER_PELIPPERWIN_5, MAP_ROUTE110),
    [REMATCH_LYDIA] = REMATCH(TRAINER_LYDIA_1, TRAINER_CARVANHA, TRAINER_BUDEW, TRAINER_BARBOACH, TRAINER_RATTATA, MAP_ROUTE117),
    [REMATCH_ISAAC] = REMATCH(TRAINER_ISAAC_1, TRAINER_ISAAC_2, TRAINER_ISAAC_3, TRAINER_ISAAC_4, TRAINER_ISAAC_5, MAP_ROUTE117),
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_SKITTY, TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_3, TRAINER_GABRIELLE_4, TRAINER_GABRIELLE_5, MAP_MT_PYRE_3F),
    [REMATCH_CATHERINE] = REMATCH(TRAINER_MAKUHITA, TRAINER_CATHERINE_2, TRAINER_CATHERINE_3, TRAINER_CATHERINE_4, TRAINER_CATHERINE_5, MAP_ROUTE119),
    [REMATCH_JACKSON] = REMATCH(TRAINER_VULPIX, TRAINER_SPOINK, TRAINER_MAWILESABELEYE, TRAINER_ARON, TRAINER_MEDITITE, MAP_ROUTE119),
    ...
    [REMATCH_SAWYER] = REMATCH(TRAINER_ZIGZAGOON, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MAP_MT_CHIMNEY),
