...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_FOREWARNACTIVATES]                    = COMPOUND_STRING("{B_SCR_ABILITY} reduced the PP of {B_EFF_NAME_WITH_PREFIX2}'s {B_BUFF1}!"),
    ...
    [STRINGID_PRESSUREENTERS]                       = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} is exerting its pressure! The enemy's stat buffs are reset."),
    ...
    [STRINGID_PICKUPCLEAREDHAZARDS]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} picked up the hazards around its team!"),
    ...
    [STRINGID_DEOXYSMUTATIONACTIVATED]              = COMPOUND_STRING("Your Deoxys Mutation activated."),
};
...
const u8 gText_BattleMenu[] = _("Battle{CLEAR_TO 56}Enemy\nPokémon{CLEAR_TO 56}Run");
