...
{//   Item                      1+  11+  21+  31+  41+  51+  61+  71+  81+  91+   Levels
    ...
    { ITEM_SPATK_GOLD_BOTTLE_CAP,   {   _,   _,   1,   4,   4,   4,   4,   5,   4,   5, } },
