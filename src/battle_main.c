...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_ELITE_FOUR] = { _("ELITE FOUR"), 5, BALL_ULTRA },
    [TRAINER_CLASS_LEADER] = { _("LEADER"), 5, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    ...
    [TRAINER_CLASS_CHAMPION] = { _("CHAMPION"), 7, BALL_ULTRA },
...
static void HandleEndTurn_FinishBattle(void)
{
    if (gCurrentActionFuncId == B_ACTION_TRY_FINISH || gCurrentActionFuncId == B_ACTION_FINISHED)
    {
        ...
        FadeOutMapMusic(5);
        // Player's party always leaves battle holding the same items it entered with
        TryRestoreHeldItems();
