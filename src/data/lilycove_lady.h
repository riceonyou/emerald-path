...
static const struct LilycoveQuizLadyQuestions sQuizLadyQuestions[] =
{
    ...
    {.question = sQuizLadyQuestion12, .answer = EC_WORD_TELEVISION, .prize = ITEM_SPDEF_BOTTLE_CAP},
    {.question = sQuizLadyQuestion13, .answer = EC_WORD_PLUSH_DOLL, .prize = ITEM_MAXIES_GLASSES_CHARM},
...
static const struct LilycoveFavorLady sFavorLady[] =
{
    ...
    {.request = COMPOUND_STRING("roundish"), .acceptedItems = sFavorLadyAcceptedItems_Roundish, .prize = ITEM_HP_GOLD_BOTTLE_CAP},
