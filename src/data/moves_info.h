...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_FIRE_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            "A fiery punch with 0.15 chance\n"
            "to burn the foe."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_FIRE,
    ...
    [MOVE_THUNDER_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            "An electrified punch with 0.15\n"
            "chance to paralyze the foe."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_WING_ATTACK] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Has 1 priority."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_2 ? 40 : 35,
        .type = TYPE_FLYING,
        .accuracy = 100,
        .pp = 35,
        .target = TARGET_SELECTED,
    ...
    [MOVE_ROLLING_KICK] =
    {
        ...
        .description = COMPOUND_STRING(
            "A fast rolling kick that has\n"
            "0.3 chance to flinch."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
    ...
    [MOVE_BODY_SLAM] =
    {
        ...
        .description = COMPOUND_STRING(
            "A full-body slam that has\n"
            "0.3 chance to cause paralysis."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_POISON_STING] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            ...
            .chance = B_UPDATED_MOVE_DATA >= GEN_2 ? 50 : 20,
        }),
    ...
    [MOVE_TWINEEDLE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Foreleg stingers jab foe twice\n"
            "with 0.5 chance to poison."),
        .effect = EFFECT_HIT,
        .power = 30,
        .type = TYPE_BUG,
        .accuracy = 100,
    ...
    [MOVE_ACID] =
    {
        ...
        .category = DAMAGE_CATEGORY_SPECIAL,
            ...
            .chance = B_UPDATED_MOVE_DATA >= GEN_2 ? 50 : 33,
        }),
    ...
    [MOVE_ICE_BEAM] =
    {
        ...
        .description = COMPOUND_STRING(
            "Blasts the foe with an icy beam\n"
        #if B_USE_FROSTBITE == TRUE
            "with 0.2 chance to frostbite."),
        #else
            "with 0.2 chance to freeze."),
        #endif
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 90 : 95,
        .type = TYPE_ICE,
    ...
    [MOVE_BLIZZARD] =
    {
        ...
        .description = COMPOUND_STRING(
            "Hits the foes with an icy storm\n"
        #if B_USE_FROSTBITE == TRUE
            "with 0.25 chance to frostbite."),
        #else
            "with 0.25 chance to freeze."),
        #endif
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 110 : 120,
        .type = TYPE_ICE,
    ...
    [MOVE_BUBBLE_BEAM] =
    {
        ...
        .description = COMPOUND_STRING(
            "Forcefully sprays bubbles with\n"
            "0.3 chance to lower Speed."),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_DRILL_PECK] =
    {
        ...
        .description = COMPOUND_STRING(
            "A screw attack with the\n"
            "beak that breaks screens."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_FLYING,
        .accuracy = 100,
    ...
    [MOVE_THUNDER] =
    {
        ...
        .description = COMPOUND_STRING(
            "A lightning attack with\n"
            "0.5 chance to paralyze.."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 110 : 120,
        .type = TYPE_ELECTRIC,
        .accuracy = 70,
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_PARALYSIS,
            .chance = B_UPDATED_MOVE_DATA >= GEN_2 ? 50 : 10,
        }),
    ...
    [MOVE_CONFUSION] =
    {
        ...
        .description = COMPOUND_STRING(
            "A psychic attack that has\n"
            "0.3 chance to confuse."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_PSYCHIC,
        .accuracy = 100,
    ...
    [MOVE_PSYCHIC] =
    {
        ...
        .description = COMPOUND_STRING(
            "A powerful psychic attack with\n"
            "0.3 chance to lower Sp. Def."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_PSYCHIC,
        .accuracy = 100,
    ...
    [MOVE_FIRE_BLAST] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_BURN,
            .chance = B_UPDATED_MOVE_DATA >= GEN_2 ? 30 : 30,
        }),
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_BETTER_WHEN_AUDIENCE_EXCITED : CONTEST_EFFECT_HIGHLY_APPEALING,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
        .contestComboStarterId = 0,
    ...
    [MOVE_WATERFALL] =
    {
        ...
        .description = COMPOUND_STRING(
            "Charges and climbs waterfall.\n"
            "0.2 chance to flinch."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_BUBBLE] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_SPD_MINUS_1,
            .chance = B_UPDATED_MOVE_DATA >= GEN_2 ? 40 : 33,
        }),
    ...
    [MOVE_DIZZY_PUNCH] =
    {
        ...
        #if B_UPDATED_MOVE_DATA >= GEN_2
            .description = COMPOUND_STRING(
                "A rhythmic punch that has\n"
                "0.5 chance to confuse."),
        #else
            .description = COMPOUND_STRING(
    ...
    [MOVE_FLAME_WHEEL] =///////////////////////////////
    {
        ...
        .description = COMPOUND_STRING(
            "Attack that switches out the\n"
            "user. 0.2 chance to burn."),
    ...
    [MOVE_POWDER_SNOW] =
    {
        ...
        #if B_USE_FROSTBITE == TRUE
            "gust. 0.3 chance of frostbite."),
        #else
            "gust. 0.3 chance of freezing."),
        #endif
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_ICE,
    ...
    [MOVE_OUTRAGE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "that confuses the user."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 130 : 90,
        .type = TYPE_DRAGON,
        .accuracy = 100,
    ...
    [MOVE_UPROAR] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 120 : 50,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 10,
        .target = TARGET_RANDOM,
    ...
    [MOVE_KNOCK_OFF] =
    {
        ...
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 75 : 20,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 20,
        .target = TARGET_SELECTED,
    ...
    [MOVE_LUSTER_PURGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Attacks with burst of light.\n"
            "0.5 to sharply lower Sp. Def."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_BLAZE_KICK] =
    {
        ...
        .description = COMPOUND_STRING(
            "A kick with a 1 critical-\n"
            "hit ratio. 0.1 to burn."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_FIRE,
        .accuracy = 95,
    ...
    [MOVE_ASTONISH] =
    {
        ...
        .description = COMPOUND_STRING(
            "An attack with 1 priority with\n"
            "0.1 chance to flinch."),
        .effect = EFFECT_HIT,
        .power = 30,
        .type = TYPE_GHOST,
        .accuracy = 100,
    ...
    [MOVE_SHADOW_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            "A punch thrown from the\n"
            "shadows. Lowers foe's defence."),
        .effect = EFFECT_HIT,
        .power = 70 + 5,
        .type = TYPE_GHOST,
        .accuracy = 100,
    ...
    [MOVE_LEAF_BLADE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "2 critical-hit ratio."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 85 : 70,
        .type = TYPE_GRASS,
        .accuracy = 100,
        .criticalHitStage = B_UPDATED_MOVE_DATA >= GEN_3 ? 2 : 2,
        .pp = 15,
    ...
    [MOVE_LAVA_PLUME] =
    {
        ...
        .description = COMPOUND_STRING(
            "Scarlet flames torch everything.\n"
            "0.5 to burn."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_FIRE,
    ...
    [MOVE_CROSS_POISON] =
    {
        ...
        .description = COMPOUND_STRING(
            "A slash with 0.5 to poison\n"
            "and 1 critical ratio."),
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_POISON,
        .accuracy = 100,
    ...
    [MOVE_DARK_VOID] =
    {
        ...
        .power = 0,
        .type = TYPE_DARK,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_7 ? 100 : 80,
        .pp = 2,
        .target = TARGET_BOTH,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
    ...
    [MOVE_RAZOR_SHELL] =
    {
        ...
        .description = COMPOUND_STRING(
            "Attacks with sharp shells.\n"
            "1 Crit Ratio. Lowers Defense."),
        .effect = EFFECT_HIT,
        .power = 75,
        .type = TYPE_WATER,
        .accuracy = 10,
    ...
    [MOVE_DISARMING_VOICE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Lets out a cry that can't be\n"
            "evaded. Reduces foe's Atk."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_FAIRY,
        .accuracy = 0,
    ...
    [MOVE_SPIRIT_SHACKLE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Hits twice. After being hit,\n"
            "foes can no longer escape."),
        .effect = EFFECT_HIT,
        .power = 45,
        .type = TYPE_GHOST,
        .accuracy = 100,
    ...
    [MOVE_LEAFAGE] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .criticalHitStage = B_UPDATED_MOVE_DATA >= GEN_3 ? 1 : 1,
        .contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING,
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_GROWTH},
    ...
    [MOVE_SNIPE_SHOT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Ignores effects that\n"
            "draw in moves. 1 crit ratio."),
    ...
    [MOVE_BRANCH_POKE] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user pokes the target's\n"
            "eyes. 0.2 to lower accuracy."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_GRASS,
        .accuracy = 100,
    ...
    [MOVE_ESPER_WING] =
    {
        ...
        .type = TYPE_PSYCHIC,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_9 ? 95 : 90,
        .criticalHitStage = B_UPDATED_MOVE_DATA >= GEN_3 ? 1 : 2,
        .pp = 10,
        .target = TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_TRIPLE_ARROWS] =
    {
        ...
        .description = COMPOUND_STRING(
            "Hits 3 times. 1 crit ratio.\n"
            "0.5 to lower Defense."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_9 ? 25 : 50,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = B_UPDATED_MOVE_DATA >= GEN_9 ? 10 : 15,
        .criticalHitStage = B_UPDATED_MOVE_DATA >= GEN_3 ? 1 : 2,
