...
FLAG_MEMORY_MUSHROOM_UNLOCKED,\
FLAG_RARE_CANDY_UNLOCKED,\
FLAG_ORAN_BERRY_UNLOCKED,\
FLAG_LUM_BERRY_UNLOCKED,\
FLAG_SERIOUS_MINT_UNLOCKED,\
...
FLAG_ITEM_VENUSAURITE_BUYABLE,\
FLAG_ITEM_CHARIZARDITE_Y_BUYABLE,\
FLAG_ITEM_BLASTOISINITE_BUYABLE,\
FLAG_ITEM_BEEDRILLITE_BUYABLE,\
FLAG_ITEM_PIDGEOTITE_BUYABLE,\
FLAG_ITEM_ALAKAZITE_BUYABLE,\
FLAG_ITEM_SLOWBRONITE_BUYABLE,\
FLAG_ITEM_GENGARITE_BUYABLE,\
FLAG_ITEM_KANGASKHANITE_BUYABLE,\
FLAG_ITEM_PINSIRITE_BUYABLE,\
FLAG_ITEM_GYARADOSITE_BUYABLE,\
FLAG_ITEM_AERODACTYLITE_BUYABLE,\
FLAG_ITEM_AMPHAROSITE_BUYABLE,\
FLAG_ITEM_STEELIXITE_BUYABLE,\
FLAG_ITEM_SCIZORITE_BUYABLE,\
FLAG_ITEM_HERACRONITE_BUYABLE,\
FLAG_ITEM_HOUNDOOMINITE_BUYABLE,\
FLAG_ITEM_TYRANITARITE_BUYABLE,\
FLAG_ITEM_SCEPTILITE_BUYABLE,\
FLAG_ITEM_BLAZIKENITE_BUYABLE,\
FLAG_ITEM_SWAMPERTITE_BUYABLE,\
FLAG_ITEM_GARDEVOIRITE_BUYABLE,\
FLAG_ITEM_SABLENITE_BUYABLE,\
FLAG_ITEM_MAWILITE_BUYABLE,\
FLAG_ITEM_AGGRONITE_BUYABLE,\
FLAG_ITEM_MEDICHAMITE_BUYABLE,\
FLAG_ITEM_MANECTITE_BUYABLE,\
FLAG_ITEM_SHARPEDONITE_BUYABLE,\
FLAG_ITEM_CAMERUPTITE_BUYABLE,\
FLAG_ITEM_ALTARIANITE_BUYABLE,\
FLAG_ITEM_BANETTITE_BUYABLE,\
FLAG_ITEM_ABSOLITE_BUYABLE,\
FLAG_ITEM_GLALITITE_BUYABLE,\
FLAG_ITEM_SALAMENCITE_BUYABLE,\
FLAG_ITEM_METAGROSSITE_BUYABLE,\
FLAG_ITEM_LOPUNNITE_BUYABLE,\
FLAG_ITEM_GARCHOMPITE_BUYABLE,\
FLAG_ITEM_LUCARIONITE_BUYABLE,\
FLAG_ITEM_ABOMASITE_BUYABLE,\
FLAG_ITEM_GALLADITE_BUYABLE,\
FLAG_ITEM_AUDINITE_BUYABLE,\
FLAG_ITEM_CLEFABLITE_BUYABLE,\
FLAG_ITEM_VICTREEBELITE_BUYABLE,\
FLAG_ITEM_STARMINITE_BUYABLE,\
FLAG_ITEM_DRAGONINITE_BUYABLE,\
FLAG_ITEM_MEGANIUMITE_BUYABLE,\
FLAG_ITEM_FERALIGITE_BUYABLE,\
FLAG_ITEM_SKARMORITE_BUYABLE,\
FLAG_ITEM_FROSLASSITE_BUYABLE,\
FLAG_ITEM_EMBOARITE_BUYABLE,\
FLAG_ITEM_EXCADRITE_BUYABLE,\
FLAG_ITEM_SCOLIPITE_BUYABLE,\
FLAG_ITEM_SCRAFTINITE_BUYABLE,\
FLAG_ITEM_EELEKTROSSITE_BUYABLE,\
FLAG_ITEM_CHANDELURITE_BUYABLE,\
FLAG_ITEM_CHESNAUGHTITE_BUYABLE,\
FLAG_ITEM_DELPHOXITE_BUYABLE,\
FLAG_ITEM_GRENINJITE_BUYABLE,\
FLAG_ITEM_PYROARITE_BUYABLE,\
FLAG_ITEM_MALAMARITE_BUYABLE,\
FLAG_ITEM_BARBARACITE_BUYABLE,\
FLAG_ITEM_DRAGALGITE_BUYABLE,\
FLAG_ITEM_HAWLUCHANITE_BUYABLE,\
FLAG_ITEM_DRAMPANITE_BUYABLE,\
FLAG_ITEM_FALINKSITE_BUYABLE,\
FLAG_ITEM_RAICHUNITE_X_BUYABLE,\
FLAG_ITEM_RAICHUNITE_Y_BUYABLE,\
FLAG_ITEM_CHIMECHITE_BUYABLE,\
FLAG_ITEM_STARAPTITE_BUYABLE,\
FLAG_ITEM_GOLURKITE_BUYABLE,\
FLAG_ITEM_MEOWSTICITE_BUYABLE,\
FLAG_ITEM_CRABOMINITE_BUYABLE,\
FLAG_ITEM_GOLISOPITE_BUYABLE,\
FLAG_ITEM_SCOVILLAINITE_BUYABLE,\
FLAG_ITEM_BAXCALIBRITE_BUYABLE,\
FLAG_ITEM_GLIMMORANITE_BUYABLE,\
FLAG_ITEM_VENUSAURITE_UNLOCKED,\
FLAG_ITEM_CHARIZARDITE_X_UNLOCKED,\
FLAG_ITEM_CHARIZARDITE_Y_UNLOCKED,\
FLAG_ITEM_BLASTOISINITE_UNLOCKED,\
FLAG_ITEM_BEEDRILLITE_UNLOCKED,\
FLAG_ITEM_PIDGEOTITE_UNLOCKED,\
FLAG_ITEM_ALAKAZITE_UNLOCKED,\
FLAG_ITEM_SLOWBRONITE_UNLOCKED,\
FLAG_ITEM_GENGARITE_UNLOCKED,\
FLAG_ITEM_KANGASKHANITE_UNLOCKED,\
FLAG_ITEM_PINSIRITE_UNLOCKED,\
FLAG_ITEM_GYARADOSITE_UNLOCKED,\
FLAG_ITEM_AERODACTYLITE_UNLOCKED,\
FLAG_ITEM_CLEFABLITE_UNLOCKED,\
FLAG_ITEM_VICTREEBELITE_UNLOCKED,\
FLAG_ITEM_AMPHAROSITE_UNLOCKED,\
FLAG_ITEM_STEELIXITE_UNLOCKED,\
FLAG_ITEM_SCIZORITE_UNLOCKED,\
FLAG_ITEM_HERACRONITE_UNLOCKED,\
FLAG_ITEM_HOUNDOOMINITE_UNLOCKED,\
FLAG_ITEM_TYRANITARITE_UNLOCKED,\
FLAG_ITEM_SCEPTILITE_UNLOCKED,\
FLAG_ITEM_BLAZIKENITE_UNLOCKED,\
FLAG_ITEM_SWAMPERTITE_UNLOCKED,\
FLAG_ITEM_GARDEVOIRITE_UNLOCKED,\
FLAG_ITEM_SABLENITE_UNLOCKED,\
FLAG_ITEM_MAWILITE_UNLOCKED,\
FLAG_ITEM_AGGRONITE_UNLOCKED,\
FLAG_ITEM_MEDICHAMITE_UNLOCKED,\
FLAG_ITEM_MANECTITE_UNLOCKED,\
FLAG_ITEM_SHARPEDONITE_UNLOCKED,\
FLAG_ITEM_CAMERUPTITE_UNLOCKED,\
FLAG_ITEM_ALTARIANITE_UNLOCKED,\
FLAG_ITEM_BANETTITE_UNLOCKED,\
FLAG_ITEM_ABSOLITE_UNLOCKED,\
FLAG_ITEM_GLALITITE_UNLOCKED,\
FLAG_ITEM_SALAMENCITE_UNLOCKED,\
FLAG_ITEM_METAGROSSITE_UNLOCKED,\
FLAG_ITEM_STARMINITE_UNLOCKED,\
FLAG_ITEM_DRAGONINITE_UNLOCKED,\
FLAG_ITEM_LOPUNNITE_UNLOCKED,\
FLAG_ITEM_GARCHOMPITE_UNLOCKED,\
FLAG_ITEM_LUCARIONITE_UNLOCKED,\
FLAG_ITEM_ABOMASITE_UNLOCKED,\
FLAG_ITEM_GALLADITE_UNLOCKED,\
FLAG_ITEM_AUDINITE_UNLOCKED,\
FLAG_ITEM_MEGANIUMITE_UNLOCKED,\
FLAG_ITEM_FERALIGITE_UNLOCKED,\
FLAG_ITEM_SKARMORITE_UNLOCKED,\
FLAG_ITEM_FROSLASSITE_UNLOCKED,\
FLAG_ITEM_EMBOARITE_UNLOCKED,\
FLAG_ITEM_EXCADRITE_UNLOCKED,\
FLAG_ITEM_SCOLIPITE_UNLOCKED,\
FLAG_ITEM_SCRAFTINITE_UNLOCKED,\
FLAG_ITEM_EELEKTROSSITE_UNLOCKED,\
FLAG_ITEM_CHANDELURITE_UNLOCKED,\
FLAG_ITEM_CHESNAUGHTITE_UNLOCKED,\
FLAG_ITEM_DELPHOXITE_UNLOCKED,\
FLAG_ITEM_GRENINJITE_UNLOCKED,\
FLAG_ITEM_PYROARITE_UNLOCKED,\
FLAG_ITEM_MALAMARITE_UNLOCKED,\
FLAG_ITEM_BARBARACITE_UNLOCKED,\
FLAG_ITEM_DRAGALGITE_UNLOCKED,\
FLAG_ITEM_HAWLUCHANITE_UNLOCKED,\
FLAG_ITEM_DRAMPANITE_UNLOCKED,\
FLAG_ITEM_FALINKSITE_UNLOCKED,\
FLAG_ITEM_RAICHUNITE_X_UNLOCKED,\
FLAG_ITEM_RAICHUNITE_Y_UNLOCKED,\
FLAG_ITEM_CHIMECHITE_UNLOCKED,\
FLAG_ITEM_STARAPTITE_UNLOCKED,\
FLAG_ITEM_GOLURKITE_UNLOCKED,\
FLAG_ITEM_MEOWSTICITE_UNLOCKED,\
FLAG_ITEM_CRABOMINITE_UNLOCKED,\
FLAG_ITEM_GOLISOPITE_UNLOCKED,\
FLAG_ITEM_SCOVILLAINITE_UNLOCKED,\
...
static void BuildOwnedSpeciesCache(void);
static void SetOwnedMegaStoneBuyableFlags(void);
...
static EWRAM_DATA bool8 sOwnedSpecies[NUM_SPECIES] = {0};
static void BuildOwnedSpeciesCache(void)
{
    u8 i;
    u8 j;

    memset(sOwnedSpecies, FALSE, sizeof(sOwnedSpecies));
    if (!IsNuzlockeActive())
        return;
    ...
    for (i = 0; i < PARTY_SIZE; i++)
    {
        if(!(GetMonData(&gPlayerParty[i], MON_DATA_HP) == 0)){
            ...
            if (partySpecies != SPECIES_NONE && partySpecies < NUM_SPECIES)
                sOwnedSpecies[partySpecies] = TRUE;
        }
    }
        ...
        for (j = 0; j < IN_BOX_COUNT; j++)
        {
            ...
            if(!(GetBoxMonData(boxMon, MON_DATA_HP) == 0)){
                ...
                if (boxSpecies != SPECIES_NONE && boxSpecies < NUM_SPECIES)
                    sOwnedSpecies[boxSpecies] = TRUE;
            }
        }
    }
}

struct MegaStoneBuyable
{
    u16 flag;
    u16 species;
};

static const struct MegaStoneBuyable sMegaStoneBuyables[] =
{
    {FLAG_ITEM_VENUSAURITE_BUYABLE, SPECIES_VENUSAUR},
    {FLAG_ITEM_CHARIZARDITE_Y_BUYABLE, SPECIES_CHARIZARD},
    {FLAG_ITEM_BLASTOISINITE_BUYABLE, SPECIES_BLASTOISE},
    {FLAG_ITEM_BEEDRILLITE_BUYABLE, SPECIES_BEEDRILL},
    {FLAG_ITEM_PIDGEOTITE_BUYABLE, SPECIES_PIDGEOT},
    {FLAG_ITEM_ALAKAZITE_BUYABLE, SPECIES_ALAKAZAM},
    {FLAG_ITEM_SLOWBRONITE_BUYABLE, SPECIES_SLOWBRO},
    {FLAG_ITEM_GENGARITE_BUYABLE, SPECIES_GENGAR},
    {FLAG_ITEM_KANGASKHANITE_BUYABLE, SPECIES_KANGASKHAN},
    {FLAG_ITEM_PINSIRITE_BUYABLE, SPECIES_PINSIR},
    {FLAG_ITEM_GYARADOSITE_BUYABLE, SPECIES_GYARADOS},
    {FLAG_ITEM_AERODACTYLITE_BUYABLE, SPECIES_AERODACTYL},
    {FLAG_ITEM_AMPHAROSITE_BUYABLE, SPECIES_AMPHAROS},
    {FLAG_ITEM_STEELIXITE_BUYABLE, SPECIES_STEELIX},
    {FLAG_ITEM_SCIZORITE_BUYABLE, SPECIES_SCIZOR},
    {FLAG_ITEM_HERACRONITE_BUYABLE, SPECIES_HERACROSS},
    {FLAG_ITEM_HOUNDOOMINITE_BUYABLE, SPECIES_HOUNDOOM},
    {FLAG_ITEM_TYRANITARITE_BUYABLE, SPECIES_TYRANITAR},
    {FLAG_ITEM_SCEPTILITE_BUYABLE, SPECIES_SCEPTILE},
    {FLAG_ITEM_BLAZIKENITE_BUYABLE, SPECIES_BLAZIKEN},
    {FLAG_ITEM_SWAMPERTITE_BUYABLE, SPECIES_SWAMPERT},
    {FLAG_ITEM_GARDEVOIRITE_BUYABLE, SPECIES_GARDEVOIR},
    {FLAG_ITEM_SABLENITE_BUYABLE, SPECIES_SABLEYE},
    {FLAG_ITEM_MAWILITE_BUYABLE, SPECIES_MAWILE},
    {FLAG_ITEM_AGGRONITE_BUYABLE, SPECIES_AGGRON},
    {FLAG_ITEM_MEDICHAMITE_BUYABLE, SPECIES_MEDICHAM},
    {FLAG_ITEM_MANECTITE_BUYABLE, SPECIES_MANECTRIC},
    {FLAG_ITEM_SHARPEDONITE_BUYABLE, SPECIES_SHARPEDO},
    {FLAG_ITEM_CAMERUPTITE_BUYABLE, SPECIES_CAMERUPT},
    {FLAG_ITEM_ALTARIANITE_BUYABLE, SPECIES_ALTARIA},
    {FLAG_ITEM_BANETTITE_BUYABLE, SPECIES_BANETTE},
    {FLAG_ITEM_ABSOLITE_BUYABLE, SPECIES_ABSOL},
    {FLAG_ITEM_GLALITITE_BUYABLE, SPECIES_GLALIE},
    {FLAG_ITEM_SALAMENCITE_BUYABLE, SPECIES_SALAMENCE},
    {FLAG_ITEM_METAGROSSITE_BUYABLE, SPECIES_METAGROSS},
    {FLAG_ITEM_LOPUNNITE_BUYABLE, SPECIES_LOPUNNY},
    {FLAG_ITEM_GARCHOMPITE_BUYABLE, SPECIES_GARCHOMP},
    {FLAG_ITEM_LUCARIONITE_BUYABLE, SPECIES_LUCARIO},
    {FLAG_ITEM_ABOMASITE_BUYABLE, SPECIES_ABOMASNOW},
    {FLAG_ITEM_GALLADITE_BUYABLE, SPECIES_GALLADE},
    {FLAG_ITEM_AUDINITE_BUYABLE, SPECIES_AUDINO},
    {FLAG_ITEM_CLEFABLITE_BUYABLE, SPECIES_CLEFABLE},
    {FLAG_ITEM_VICTREEBELITE_BUYABLE, SPECIES_VICTREEBEL},
    {FLAG_ITEM_STARMINITE_BUYABLE, SPECIES_STARMIE},
    {FLAG_ITEM_DRAGONINITE_BUYABLE, SPECIES_DRAGONITE},
    {FLAG_ITEM_MEGANIUMITE_BUYABLE, SPECIES_MEGANIUM},
    {FLAG_ITEM_FERALIGITE_BUYABLE, SPECIES_FERALIGATR},
    {FLAG_ITEM_SKARMORITE_BUYABLE, SPECIES_SKARMORY},
    {FLAG_ITEM_FROSLASSITE_BUYABLE, SPECIES_FROSLASS},
    {FLAG_ITEM_EMBOARITE_BUYABLE, SPECIES_EMBOAR},
    {FLAG_ITEM_EXCADRITE_BUYABLE, SPECIES_EXCADRILL},
    {FLAG_ITEM_SCOLIPITE_BUYABLE, SPECIES_SCOLIPEDE},
    {FLAG_ITEM_SCRAFTINITE_BUYABLE, SPECIES_SCRAFTY},
    {FLAG_ITEM_EELEKTROSSITE_BUYABLE, SPECIES_EELEKTROSS},
    {FLAG_ITEM_CHANDELURITE_BUYABLE, SPECIES_CHANDELURE},
    {FLAG_ITEM_CHESNAUGHTITE_BUYABLE, SPECIES_CHESNAUGHT},
    {FLAG_ITEM_DELPHOXITE_BUYABLE, SPECIES_DELPHOX},
    {FLAG_ITEM_GRENINJITE_BUYABLE, SPECIES_GRENINJA},
    {FLAG_ITEM_PYROARITE_BUYABLE, SPECIES_PYROAR},
    {FLAG_ITEM_MALAMARITE_BUYABLE, SPECIES_MALAMAR},
    {FLAG_ITEM_BARBARACITE_BUYABLE, SPECIES_BARBARACLE},
    {FLAG_ITEM_DRAGALGITE_BUYABLE, SPECIES_DRAGALGE},
    {FLAG_ITEM_HAWLUCHANITE_BUYABLE, SPECIES_HAWLUCHA},
    {FLAG_ITEM_DRAMPANITE_BUYABLE, SPECIES_DRAMPA},
    {FLAG_ITEM_FALINKSITE_BUYABLE, SPECIES_FALINKS},
    {FLAG_ITEM_RAICHUNITE_X_BUYABLE, SPECIES_RAICHU},
    {FLAG_ITEM_RAICHUNITE_Y_BUYABLE, SPECIES_RAICHU_ALOLA},
    {FLAG_ITEM_CHIMECHITE_BUYABLE, SPECIES_CHIMECHO},
    {FLAG_ITEM_STARAPTITE_BUYABLE, SPECIES_STARAPTOR},
    {FLAG_ITEM_GOLURKITE_BUYABLE, SPECIES_GOLURK},
    {FLAG_ITEM_MEOWSTICITE_BUYABLE, SPECIES_MEOWSTIC},
    {FLAG_ITEM_CRABOMINITE_BUYABLE, SPECIES_CRABOMINABLE},
    {FLAG_ITEM_GOLISOPITE_BUYABLE, SPECIES_GOLISOPOD},
    {FLAG_ITEM_SCOVILLAINITE_BUYABLE, SPECIES_SCOVILLAIN},
    {FLAG_ITEM_BAXCALIBRITE_BUYABLE, SPECIES_BAXCALIBUR},
    {FLAG_ITEM_GLIMMORANITE_BUYABLE, SPECIES_GLIMMORA},
};
...
static void SetOwnedMegaStoneBuyableFlags(void)
{
    ...
    BuildOwnedSpeciesCache();
    for (i = 0; i < ARRAY_COUNT(sMegaStoneBuyables); i++)
    {
        if (sOwnedSpecies[sMegaStoneBuyables[i].species])
            FlagSet(sMegaStoneBuyables[i].flag);
...
void GiveSavedStarter(void)
{
    ...
    if (species != SPECIES_NONE)
        ScriptGiveMon(species, VarGet(VAR_LEVEL_CAP), ITEM_NONE, ITEM_NONE);
}

void GiveBufferedMon(void)
{
    u16 species = VarGet(VAR_RESULT);

    if (species != SPECIES_NONE)
        ScriptGiveMon(species, VarGet(VAR_LEVEL_CAP), ITEM_NONE, ITEM_NONE);
}

void ReplaceShinyStarter(void)
{
    u16 species = VarGet(VAR_STARTER_MON);
...
void UpdateLevelCap(void)
{
    ...
    switch (currentact){
        ...
        case (4): VarSet(VAR_LEVEL_CAP, 50); break;
...
void ResetPokemonAndItems(void)
{
    ...
    // if(FlagGet(FLAG_MEMORY_MUSHROOM_UNLOCKED)){AddBagItem(ITEM_MEMORY_MUSHROOM, 1);}
    // if(FlagGet(FLAG_RARE_CANDY_UNLOCKED)){AddBagItem(ITEM_MEMORY_MUSHROOM, 1);}
    // if(FlagGet(FLAG_ORAN_BERRY_UNLOCKED)){AddBagItem(ITEM_MEMORY_MUSHROOM, 1);}
    // if(FlagGet(FLAG_LUM_BERRY_UNLOCKED)){AddBagItem(ITEM_MEMORY_MUSHROOM, 1);}
    // if(FlagGet(FLAG_SERIOUS_MINT_UNLOCKED)){AddBagItem(ITEM_MEMORY_MUSHROOM, 1);}
    // if(FlagGet(FLAG_MEMORY_MUSHROOM_UNLOCKED_6)){AddBagItem(ITEM_MEMORY_MUSHROOM, 1);}
    // if(FlagGet(FLAG_MEMORY_MUSHROOM_UNLOCKED_7)){AddBagItem(ITEM_MEMORY_MUSHROOM, 1);}
    // if(FlagGet(FLAG_MEMORY_MUSHROOM_UNLOCKED_8)){AddBagItem(ITEM_MEMORY_MUSHROOM, 1);}

    // if(FlagGet(FLAG_RARE_CANDY_UNLOCKED_1)){AddBagItem(ITEM_RARE_CANDY, 1);}
    // if(FlagGet(FLAG_RARE_CANDY_UNLOCKED_2)){AddBagItem(ITEM_RARE_CANDY, 1);}
    ...
    if(FlagGet(FLAG_ITEM_CHARIZARDITE_Y_UNLOCKED)){AddBagItem(ITEM_CHARIZARDITE_Y, 1);}
    if(FlagGet(FLAG_ITEM_BLASTOISINITE_UNLOCKED)){AddBagItem(ITEM_BLASTOISINITE, 1);}
    if(FlagGet(FLAG_ITEM_BEEDRILLITE_UNLOCKED)){AddBagItem(ITEM_BEEDRILLITE, 1);}
    if(FlagGet(FLAG_ITEM_PIDGEOTITE_UNLOCKED)){AddBagItem(ITEM_PIDGEOTITE, 1);}
    if(FlagGet(FLAG_ITEM_ALAKAZITE_UNLOCKED)){AddBagItem(ITEM_ALAKAZITE, 1);}
    if(FlagGet(FLAG_ITEM_SLOWBRONITE_UNLOCKED)){AddBagItem(ITEM_SLOWBRONITE, 1);}
    if(FlagGet(FLAG_ITEM_GENGARITE_UNLOCKED)){AddBagItem(ITEM_GENGARITE, 1);}
    if(FlagGet(FLAG_ITEM_KANGASKHANITE_UNLOCKED)){AddBagItem(ITEM_KANGASKHANITE, 1);}
    if(FlagGet(FLAG_ITEM_PINSIRITE_UNLOCKED)){AddBagItem(ITEM_PINSIRITE, 1);}
    if(FlagGet(FLAG_ITEM_GYARADOSITE_UNLOCKED)){AddBagItem(ITEM_GYARADOSITE, 1);}
    if(FlagGet(FLAG_ITEM_AERODACTYLITE_UNLOCKED)){AddBagItem(ITEM_AERODACTYLITE, 1);}
    if(FlagGet(FLAG_ITEM_AMPHAROSITE_UNLOCKED)){AddBagItem(ITEM_AMPHAROSITE, 1);}
    if(FlagGet(FLAG_ITEM_STEELIXITE_UNLOCKED)){AddBagItem(ITEM_STEELIXITE, 1);}
    if(FlagGet(FLAG_ITEM_SCIZORITE_UNLOCKED)){AddBagItem(ITEM_SCIZORITE, 1);}
    if(FlagGet(FLAG_ITEM_HERACRONITE_UNLOCKED)){AddBagItem(ITEM_HERACRONITE, 1);}
    if(FlagGet(FLAG_ITEM_HOUNDOOMINITE_UNLOCKED)){AddBagItem(ITEM_HOUNDOOMINITE, 1);}
    if(FlagGet(FLAG_ITEM_TYRANITARITE_UNLOCKED)){AddBagItem(ITEM_TYRANITARITE, 1);}
    if(FlagGet(FLAG_ITEM_SCEPTILITE_UNLOCKED)){AddBagItem(ITEM_SCEPTILITE, 1);}
    if(FlagGet(FLAG_ITEM_BLAZIKENITE_UNLOCKED)){AddBagItem(ITEM_BLAZIKENITE, 1);}
    if(FlagGet(FLAG_ITEM_SWAMPERTITE_UNLOCKED)){AddBagItem(ITEM_SWAMPERTITE, 1);}
    if(FlagGet(FLAG_ITEM_GARDEVOIRITE_UNLOCKED)){AddBagItem(ITEM_GARDEVOIRITE, 1);}
    if(FlagGet(FLAG_ITEM_SABLENITE_UNLOCKED)){AddBagItem(ITEM_SABLENITE, 1);}
    if(FlagGet(FLAG_ITEM_MAWILITE_UNLOCKED)){AddBagItem(ITEM_MAWILITE, 1);}
    if(FlagGet(FLAG_ITEM_AGGRONITE_UNLOCKED)){AddBagItem(ITEM_AGGRONITE, 1);}
    if(FlagGet(FLAG_ITEM_MEDICHAMITE_UNLOCKED)){AddBagItem(ITEM_MEDICHAMITE, 1);}
    if(FlagGet(FLAG_ITEM_MANECTITE_UNLOCKED)){AddBagItem(ITEM_MANECTITE, 1);}
    if(FlagGet(FLAG_ITEM_SHARPEDONITE_UNLOCKED)){AddBagItem(ITEM_SHARPEDONITE, 1);}
    if(FlagGet(FLAG_ITEM_CAMERUPTITE_UNLOCKED)){AddBagItem(ITEM_CAMERUPTITE, 1);}
    if(FlagGet(FLAG_ITEM_ALTARIANITE_UNLOCKED)){AddBagItem(ITEM_ALTARIANITE, 1);}
    if(FlagGet(FLAG_ITEM_BANETTITE_UNLOCKED)){AddBagItem(ITEM_BANETTITE, 1);}
    if(FlagGet(FLAG_ITEM_ABSOLITE_UNLOCKED)){AddBagItem(ITEM_ABSOLITE, 1);}
    if(FlagGet(FLAG_ITEM_GLALITITE_UNLOCKED)){AddBagItem(ITEM_GLALITITE, 1);}
    if(FlagGet(FLAG_ITEM_SALAMENCITE_UNLOCKED)){AddBagItem(ITEM_SALAMENCITE, 1);}
    if(FlagGet(FLAG_ITEM_METAGROSSITE_UNLOCKED)){AddBagItem(ITEM_METAGROSSITE, 1);}
    if(FlagGet(FLAG_ITEM_LOPUNNITE_UNLOCKED)){AddBagItem(ITEM_LOPUNNITE, 1);}
    if(FlagGet(FLAG_ITEM_GARCHOMPITE_UNLOCKED)){AddBagItem(ITEM_GARCHOMPITE, 1);}
    if(FlagGet(FLAG_ITEM_LUCARIONITE_UNLOCKED)){AddBagItem(ITEM_LUCARIONITE, 1);}
    if(FlagGet(FLAG_ITEM_ABOMASITE_UNLOCKED)){AddBagItem(ITEM_ABOMASITE, 1);}
    if(FlagGet(FLAG_ITEM_GALLADITE_UNLOCKED)){AddBagItem(ITEM_GALLADITE, 1);}
    if(FlagGet(FLAG_ITEM_AUDINITE_UNLOCKED)){AddBagItem(ITEM_AUDINITE, 1);}
    if(FlagGet(FLAG_ITEM_CLEFABLITE_UNLOCKED)){AddBagItem(ITEM_CLEFABLITE, 1);}
    if(FlagGet(FLAG_ITEM_VICTREEBELITE_UNLOCKED)){AddBagItem(ITEM_VICTREEBELITE, 1);}
    if(FlagGet(FLAG_ITEM_STARMINITE_UNLOCKED)){AddBagItem(ITEM_STARMINITE, 1);}
    if(FlagGet(FLAG_ITEM_DRAGONINITE_UNLOCKED)){AddBagItem(ITEM_DRAGONINITE, 1);}
    if(FlagGet(FLAG_ITEM_MEGANIUMITE_UNLOCKED)){AddBagItem(ITEM_MEGANIUMITE, 1);}
    if(FlagGet(FLAG_ITEM_FERALIGITE_UNLOCKED)){AddBagItem(ITEM_FERALIGITE, 1);}
    if(FlagGet(FLAG_ITEM_SKARMORITE_UNLOCKED)){AddBagItem(ITEM_SKARMORITE, 1);}
    if(FlagGet(FLAG_ITEM_FROSLASSITE_UNLOCKED)){AddBagItem(ITEM_FROSLASSITE, 1);}
    if(FlagGet(FLAG_ITEM_EMBOARITE_UNLOCKED)){AddBagItem(ITEM_EMBOARITE, 1);}
    if(FlagGet(FLAG_ITEM_EXCADRITE_UNLOCKED)){AddBagItem(ITEM_EXCADRITE, 1);}
    if(FlagGet(FLAG_ITEM_SCOLIPITE_UNLOCKED)){AddBagItem(ITEM_SCOLIPITE, 1);}
    if(FlagGet(FLAG_ITEM_SCRAFTINITE_UNLOCKED)){AddBagItem(ITEM_SCRAFTINITE, 1);}
    if(FlagGet(FLAG_ITEM_EELEKTROSSITE_UNLOCKED)){AddBagItem(ITEM_EELEKTROSSITE, 1);}
    if(FlagGet(FLAG_ITEM_CHANDELURITE_UNLOCKED)){AddBagItem(ITEM_CHANDELURITE, 1);}
    if(FlagGet(FLAG_ITEM_CHESNAUGHTITE_UNLOCKED)){AddBagItem(ITEM_CHESNAUGHTITE, 1);}
    if(FlagGet(FLAG_ITEM_DELPHOXITE_UNLOCKED)){AddBagItem(ITEM_DELPHOXITE, 1);}
    if(FlagGet(FLAG_ITEM_GRENINJITE_UNLOCKED)){AddBagItem(ITEM_GRENINJITE, 1);}
    if(FlagGet(FLAG_ITEM_PYROARITE_UNLOCKED)){AddBagItem(ITEM_PYROARITE, 1);}
    if(FlagGet(FLAG_ITEM_MALAMARITE_UNLOCKED)){AddBagItem(ITEM_MALAMARITE, 1);}
    if(FlagGet(FLAG_ITEM_BARBARACITE_UNLOCKED)){AddBagItem(ITEM_BARBARACITE, 1);}
    if(FlagGet(FLAG_ITEM_DRAGALGITE_UNLOCKED)){AddBagItem(ITEM_DRAGALGITE, 1);}
    if(FlagGet(FLAG_ITEM_HAWLUCHANITE_UNLOCKED)){AddBagItem(ITEM_HAWLUCHANITE, 1);}
    if(FlagGet(FLAG_ITEM_DRAMPANITE_UNLOCKED)){AddBagItem(ITEM_DRAMPANITE, 1);}
    if(FlagGet(FLAG_ITEM_FALINKSITE_UNLOCKED)){AddBagItem(ITEM_FALINKSITE, 1);}
    if(FlagGet(FLAG_ITEM_RAICHUNITE_X_UNLOCKED)){AddBagItem(ITEM_RAICHUNITE_X, 1);}
    if(FlagGet(FLAG_ITEM_RAICHUNITE_Y_UNLOCKED)){AddBagItem(ITEM_RAICHUNITE_Y, 1);}
    if(FlagGet(FLAG_ITEM_CHIMECHITE_UNLOCKED)){AddBagItem(ITEM_CHIMECHITE, 1);}
    if(FlagGet(FLAG_ITEM_STARAPTITE_UNLOCKED)){AddBagItem(ITEM_STARAPTITE, 1);}
    if(FlagGet(FLAG_ITEM_GOLURKITE_UNLOCKED)){AddBagItem(ITEM_GOLURKITE, 1);}
    if(FlagGet(FLAG_ITEM_MEOWSTICITE_UNLOCKED)){AddBagItem(ITEM_MEOWSTICITE, 1);}
    if(FlagGet(FLAG_ITEM_CRABOMINITE_UNLOCKED)){AddBagItem(ITEM_CRABOMINITE, 1);}
    if(FlagGet(FLAG_ITEM_GOLISOPITE_UNLOCKED)){AddBagItem(ITEM_GOLISOPITE, 1);}
    if(FlagGet(FLAG_ITEM_SCOVILLAINITE_UNLOCKED)){AddBagItem(ITEM_SCOVILLAINITE, 1);}
    if(FlagGet(FLAG_ITEM_GLIMMORANITE_UNLOCKED)){AddBagItem(ITEM_GLIMMORANITE, 1);}
    if(FlagGet(FLAG_ITEM_BAXCALIBRITE_UNLOCKED)){AddBagItem(ITEM_BAXCALIBRITE, 1);}
...
static void LoadMapFromWarp(bool32 a1)
{
    ...
    ChooseAmbientCrySpecies();
    //if (isOutdoors)
        //FlagClear(FLAG_ITEM_CRABOMINITE);
    SetDefaultFlashLevel();
    Overworld_ClearSavedMusic();
    RunOnTransitionMapScript();
    UpdateLocationHistoryForRoamer();
...
void SetDefaultFlashLevel(void)
{
    ...
    else if (FlagGet(FLAG_ITEM_CRABOMINITE_UNLOCKED))
