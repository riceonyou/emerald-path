...
void ResetPokemonAndItems(void)
{
    ...
    if(FlagGet(FLAG_MEMORY_MUSHROOM_UNLOCKED_1)){AddBagItem(ITEM_MEMORY_MUSHROOM, 1);}
    if(FlagGet(FLAG_MEMORY_MUSHROOM_UNLOCKED_2)){AddBagItem(ITEM_MEMORY_MUSHROOM, 1);}
    if(FlagGet(FLAG_MEMORY_MUSHROOM_UNLOCKED_3)){AddBagItem(ITEM_MEMORY_MUSHROOM, 1);}
    if(FlagGet(FLAG_MEMORY_MUSHROOM_UNLOCKED_4)){AddBagItem(ITEM_MEMORY_MUSHROOM, 1);}
    if(FlagGet(FLAG_MEMORY_MUSHROOM_UNLOCKED_5)){AddBagItem(ITEM_MEMORY_MUSHROOM, 1);}
