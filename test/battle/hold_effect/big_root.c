...
#if MAX_MON_ITEMS > 1
SINGLE_BATTLE_TEST("Big Root increases healing from absorbing moves (Items)", s16 damage, s16 heal)
{
    enum Item item;
...
SINGLE_BATTLE_TEST("Big Root increases the damage restored from Leech Seed, Ingrain and Aqua Ring (Items)", s16 heal, s16 damage)
{
    enum Item item;
    enum Move move;
...
SINGLE_BATTLE_TEST("Big Root increases damage from absorbing Liquid Ooze (Items)", s16 damage)
{
    enum Item item;
