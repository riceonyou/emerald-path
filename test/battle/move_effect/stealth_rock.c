...
#if MAX_MON_ITEMS > 1
SINGLE_BATTLE_TEST("Stealth Rock damages the correct Pokémon when Eject Button is triggered (Items)")
{
    GIVEN {
...
DOUBLE_BATTLE_TEST("Stealth Rock damages the correct Pokémon when Eject Button is triggered in double battle (Items)")
{
    GIVEN {
        PLAYER(SPECIES_METAPOD) { Items(ITEM_PECHA_BERRY, ITEM_EJECT_BUTTON); }
        PLAYER(SPECIES_METAPOD) { Items(ITEM_PECHA_BERRY, ITEM_EJECT_BUTTON); }
