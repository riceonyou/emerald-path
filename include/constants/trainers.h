...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_SUBSTITUTE,
    // GENERATED_PKMN_TRAINER_PICS_BEGIN
    TRAINER_PIC_FRONT_ABSOL_MEGA,
    TRAINER_PIC_FRONT_ARMALDO,
    TRAINER_PIC_FRONT_BLAZIKEN,
    TRAINER_PIC_FRONT_BLAZIKEN_MEGA,
    TRAINER_PIC_FRONT_CACTURNE,
    TRAINER_PIC_FRONT_CLAYDOL,
    TRAINER_PIC_FRONT_COMBUSKEN,
    TRAINER_PIC_FRONT_CRADILY,
    TRAINER_PIC_FRONT_CRAWDAUNT,
    TRAINER_PIC_FRONT_DODUO,
    TRAINER_PIC_FRONT_DUSCLOPS,
    TRAINER_PIC_FRONT_ELECTRODE,
    TRAINER_PIC_FRONT_FLYGON,
    TRAINER_PIC_FRONT_GARDEVOIR_MEGA,
    TRAINER_PIC_FRONT_GLALIE_MEGA,
    TRAINER_PIC_FRONT_GROVYLE,
    TRAINER_PIC_FRONT_LINOONE,
    TRAINER_PIC_FRONT_LOTAD,
    TRAINER_PIC_FRONT_LOUDRED,
    TRAINER_PIC_FRONT_MAGNETON,
    TRAINER_PIC_FRONT_MANECTRIC,
    TRAINER_PIC_FRONT_NINCADA,
    TRAINER_PIC_FRONT_NINETALES,
    TRAINER_PIC_FRONT_NOSEPASS,
    TRAINER_PIC_FRONT_ODDISH,
    TRAINER_PIC_FRONT_PELIPPER,
    TRAINER_PIC_FRONT_PLUSLE,
    TRAINER_PIC_FRONT_POOCHYENA,
    TRAINER_PIC_FRONT_ROSELIA,
    TRAINER_PIC_FRONT_SABLEYE_MEGA,
    TRAINER_PIC_FRONT_SALAMENCE_MEGA,
    TRAINER_PIC_FRONT_SANDSLASH,
    TRAINER_PIC_FRONT_SCEPTILE,
    TRAINER_PIC_FRONT_SCEPTILE_MEGA,
    TRAINER_PIC_FRONT_SEEDOT,
    TRAINER_PIC_FRONT_SEVIPER,
    TRAINER_PIC_FRONT_SHARPEDO,
    TRAINER_PIC_FRONT_SHROOMISH,
    TRAINER_PIC_FRONT_SKARMORY,
    TRAINER_PIC_FRONT_SKITTY,
    TRAINER_PIC_FRONT_SLAKING,
    TRAINER_PIC_FRONT_SLAKOTH,
    TRAINER_PIC_FRONT_SOLROCK,
    TRAINER_PIC_FRONT_SPINDA,
    TRAINER_PIC_FRONT_SURSKIT,
    TRAINER_PIC_FRONT_SWALOT,
    TRAINER_PIC_FRONT_SWAMPERT_MEGA,
    TRAINER_PIC_FRONT_TAILLOW,
    TRAINER_PIC_FRONT_TORCHIC,
    TRAINER_PIC_FRONT_TREECKO,
    TRAINER_PIC_FRONT_VOLBEAT,
    TRAINER_PIC_FRONT_WAILMER,
    TRAINER_PIC_FRONT_WHISCASH,
    TRAINER_PIC_FRONT_WHISMUR,
    TRAINER_PIC_FRONT_WIGGLYTUFF,
    TRAINER_PIC_FRONT_WINGULL,
    TRAINER_PIC_FRONT_WURMPLE,
    TRAINER_PIC_FRONT_ZANGOOSE,
    TRAINER_PIC_FRONT_ZIGZAGOON,
    // GENERATED_PKMN_TRAINER_PICS_END
