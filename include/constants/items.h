...
enum __attribute__((packed)) Item
{
    ...
    ITEM_HP_GOLD_BOTTLE_CAP = 135,
    ITEM_ATK_GOLD_BOTTLE_CAP = 136,
    ITEM_DEF_GOLD_BOTTLE_CAP = 137,
    ITEM_TINYMUSHROOM = ITEM_DEF_GOLD_BOTTLE_CAP, // Pre-Gen VI name
    ITEM_SPEED_GOLD_BOTTLE_CAP = 138,
    ITEM_SPATK_GOLD_BOTTLE_CAP = 139,
    ITEM_BALMMUSHROOM = ITEM_SPATK_GOLD_BOTTLE_CAP, // Pre-Gen VI name
    ITEM_SPDEF_GOLD_BOTTLE_CAP = 140,
    ITEM_SPDEF_BOTTLE_CAP = 141,
    ITEM_SUPER_SHINY_CHARM = 142,
    ITEM_ARCHIES_BANDANA_CHARM = 143,
    ITEM_MAXIES_GLASSES_CHARM = 144,
    ITEM_LUGIA_PLATE_CHARM = 145,
    ITEM_BRUXISH_FLOSS_CHARM = 146,
    ITEM_UNOWN_BUDDY_CHARM = 147,
    ITEM_DEOXYS_MUTATION_CHARM = 148,
    ITEM_BLUE_SHARD = 149,
    ...
    ITEM_MEWTWONITE_X = 305,//not for player
    ITEM_MEWTWONITE_Y = 306,//not for player
    ...
    ITEM_LATIASITE = 330,//not for player
    ITEM_LATIOSITE = 331,//not for player
    ITEM_LOPUNNITE = 332,
    ...
    ITEM_GALLADITE = 336,
    ITEM_AUDINITE = 337,
    ITEM_DIANCITE = 338,//not for player
    ...
    // Charms
    ITEM_OVAL_CHARM = 820,
    ITEM_SHINY_CHARM = 821,
    ITEM_CATCHING_CHARM = 822,
    ITEM_EXP_CHARM = 823,

// Form-changing Key Items
    ITEM_ROTOM_CATALOG = 824,
    ITEM_GRACIDEA = 825,
    ITEM_REVEAL_GLASS = 826,
    ITEM_DNA_SPLICERS = 827,
    ITEM_ZYGARDE_CUBE = 828,
    ITEM_PRISON_BOTTLE = 829,
    ITEM_N_SOLARIZER = 830,
    ITEM_N_LUNARIZER = 831,
    ITEM_REINS_OF_UNITY = 832,

    // Battle Mechanic Key Items
    ITEM_MEGA_RING = 833,
    ITEM_Z_POWER_RING = 834,
    ITEM_DYNAMAX_BAND = 835,
    ...
    ITEM_GOOD_ROD = 840,
    ITEM_SUPER_ROD = 841,
    ITEM_DOWSING_MACHINE = 842,
    ITEM_ITEMFINDER = ITEM_DOWSING_MACHINE,
    ITEM_DOWSING_MCHN = ITEM_DOWSING_MACHINE,
    ITEM_TOWN_MAP = 843,
    ITEM_VS_SEEKER = 844,
    ITEM_TM_CASE = 845,
    ITEM_BERRY_POUCH = 846,
    ITEM_POKEMON_BOX_LINK = 847,
    ITEM_POKEMON_BOX = ITEM_POKEMON_BOX_LINK,
    ITEM_COIN_CASE = 848,
    ITEM_POWDER_JAR = 849,
    ITEM_WAILMER_PAIL = 850,
    ITEM_POKE_RADAR = 851,
    ITEM_POKEBLOCK_CASE = 852,
    ITEM_SOOT_SACK = 853,
    ITEM_POKE_FLUTE = 854,
    ITEM_FAME_CHECKER = 855,
    ITEM_TEACHY_TV = 856,

    // Story Key Items
    ITEM_SS_TICKET = 857,
    ITEM_EON_TICKET = 858,
    ITEM_MYSTIC_TICKET = 859,
    ITEM_AURORA_TICKET = 860,
    ITEM_OLD_SEA_MAP = 861,
    ITEM_LETTER = 862,
    ITEM_DEVON_PARTS = 863,
    ITEM_DEVON_GOODS = ITEM_DEVON_PARTS,
    ITEM_GO_GOGGLES = 864,
    ITEM_DEVON_SCOPE = 865,
    ITEM_BASEMENT_KEY = 866,
    ITEM_SCANNER = 867,
    ITEM_STORAGE_KEY = 868,
    ITEM_KEY_TO_ROOM_1 = 869,
    ITEM_RM_1_KEY = ITEM_KEY_TO_ROOM_1,
    ITEM_KEY_TO_ROOM_2 = 870,
    ITEM_RM_2_KEY = ITEM_KEY_TO_ROOM_2,
    ITEM_KEY_TO_ROOM_4 = 871,
    ITEM_RM_4_KEY = ITEM_KEY_TO_ROOM_4,
    ITEM_KEY_TO_ROOM_6 = 872,
    ITEM_RM_6_KEY = ITEM_KEY_TO_ROOM_6,
    ITEM_METEORITE = 873,
    ITEM_MAGMA_EMBLEM = 874,
    ITEM_CONTEST_PASS = 875,
    ITEM_PARCEL = 876,
    ITEM_OAKS_PARCEL = ITEM_PARCEL,
    ITEM_SECRET_KEY = 877,
    ITEM_BIKE_VOUCHER = 878,
    ITEM_GOLD_TEETH = 879,
    ITEM_CARD_KEY = 880,
    ITEM_LIFT_KEY = 881,
    ITEM_SILPH_SCOPE = 882,
    ITEM_TRI_PASS = 883,
    ITEM_RAINBOW_PASS = 884,
    ITEM_TEA = 885,
    ITEM_RUBY = 886,
    ITEM_SAPPHIRE = 887,

    // GEN IX ITEMS
    ITEM_ABILITY_SHIELD = 888,
    ITEM_CLEAR_AMULET = 889,
    ITEM_PUNCHING_GLOVE = 890,
    ITEM_COVERT_CLOAK = 891,
    ITEM_LOADED_DICE = 892,
    ITEM_AUSPICIOUS_ARMOR = 893,
    ITEM_BOOSTER_ENERGY = 894,
    ITEM_BIG_BAMBOO_SHOOT = 895,
    ITEM_GIMMIGHOUL_COIN = 896,
    ITEM_LEADERS_CREST = 897,
    ITEM_MALICIOUS_ARMOR = 898,
    ITEM_MIRROR_HERB = 899,
    ITEM_SCROLL_OF_DARKNESS = 900,
    ITEM_SCROLL_OF_WATERS = 901,
    ITEM_TERA_ORB = 902,
    ITEM_TINY_BAMBOO_SHOOT = 903,

    ITEM_BUG_TERA_SHARD = 904,
    ITEM_DARK_TERA_SHARD = 905,
    ITEM_DRAGON_TERA_SHARD = 906,
    ITEM_ELECTRIC_TERA_SHARD = 907,
    ITEM_FAIRY_TERA_SHARD = 908,
    ITEM_FIGHTING_TERA_SHARD = 909,
    ITEM_FIRE_TERA_SHARD = 910,
    ITEM_FLYING_TERA_SHARD = 911,
    ITEM_GHOST_TERA_SHARD = 912,
    ITEM_GRASS_TERA_SHARD = 913,
    ITEM_GROUND_TERA_SHARD = 914,
    ITEM_ICE_TERA_SHARD = 915,
    ITEM_NORMAL_TERA_SHARD = 916,
    ITEM_POISON_TERA_SHARD = 917,
    ITEM_PSYCHIC_TERA_SHARD = 918,
    ITEM_ROCK_TERA_SHARD = 919,
    ITEM_STEEL_TERA_SHARD = 920,
    ITEM_WATER_TERA_SHARD = 921,

    ITEM_ADAMANT_CRYSTAL = 922,
    ITEM_GRISEOUS_CORE = 923,
    ITEM_LUSTROUS_GLOBE = 924,

    ITEM_BLACK_AUGURITE = 925,
    ITEM_LINKING_CORD = 926,
    ITEM_PEAT_BLOCK = 927,
    ITEM_BERSERK_GENE = 928,

    ITEM_FAIRY_FEATHER = 929,
    ITEM_SYRUPY_APPLE = 930,
    ITEM_UNREMARKABLE_TEACUP = 931,
    ITEM_MASTERPIECE_TEACUP = 932,
    ITEM_CORNERSTONE_MASK = 933,
    ITEM_WELLSPRING_MASK = 934,
    ITEM_HEARTHFLAME_MASK = 935,
    ITEM_HEALTH_MOCHI = 936,
    ITEM_MUSCLE_MOCHI = 937,
    ITEM_RESIST_MOCHI = 938,
    ITEM_GENIUS_MOCHI = 939,
    ITEM_CLEVER_MOCHI = 940,
    ITEM_SWIFT_MOCHI = 941,
    ITEM_FRESH_START_MOCHI = 942,
    ITEM_GLIMMERING_CHARM = 943,
    ITEM_METAL_ALLOY = 944,
    ITEM_STELLAR_TERA_SHARD = 945,

    ITEM_JUBILIFE_MUFFIN = 946,
    ITEM_REMEDY = 947,
    ITEM_FINE_REMEDY = 948,
    ITEM_SUPERB_REMEDY = 949,
    ITEM_AUX_EVASION = 950,
    ITEM_AUX_GUARD = 951,
    ITEM_AUX_POWER = 952,
    ITEM_AUX_POWERGUARD = 953,
    ITEM_CHOICE_DUMPLING = 954,
    ITEM_SWAP_SNACK = 955,
    ITEM_TWICE_SPICED_RADISH = 956,
    ITEM_POKESHI_DOLL = 957,

    ITEM_STRANGE_BALL = 958,

    // Legends Z-A Mega Stones
    ITEM_CLEFABLITE = 959,
    ITEM_VICTREEBELITE = 960,
    ITEM_STARMINITE = 961,
    ITEM_DRAGONINITE = 962,
    ITEM_MEGANIUMITE = 963,
    ITEM_FERALIGITE = 964,
    ITEM_SKARMORITE = 965,
    ITEM_FROSLASSITE = 966,
    ITEM_EMBOARITE = 967,
    ITEM_EXCADRITE = 968,
    ITEM_SCOLIPITE = 969,
    ITEM_SCRAFTINITE = 970,
    ITEM_EELEKTROSSITE = 971,
    ITEM_CHANDELURITE = 972,
    ITEM_CHESNAUGHTITE = 973,
    ITEM_DELPHOXITE = 974,
    ITEM_GRENINJITE = 975,
    ITEM_PYROARITE = 976,
    ITEM_FLOETTITE = 977,//not for player
    ITEM_MALAMARITE = 978,
    ITEM_BARBARACITE = 979,
    ITEM_DRAGALGITE = 980,
    ITEM_HAWLUCHANITE = 981,
    ITEM_ZYGARDITE = 982,//not for player
    ITEM_DRAMPANITE = 983,
    ITEM_FALINKSITE = 984,

    // Legends Z-A: Mega Dimension DLC Mega Stones
    ITEM_HEATRANITE = 985,//not for player
    ITEM_DARKRANITE = 986,//not for player
    ITEM_ZERAORITE = 987,//not for player
    ITEM_RAICHUNITE_X = 988,
    ITEM_RAICHUNITE_Y = 989,
    ITEM_CHIMECHITE = 990,
    ITEM_ABSOLITE_Z = 991,//not for player
    ITEM_STARAPTITE = 992,
    ITEM_GARCHOMPITE_Z = 993,//not for player
    ITEM_LUCARIONITE_Z = 994,//not for player
    ITEM_GOLURKITE = 995,
    ITEM_MEOWSTICITE = 996,
    ITEM_CRABOMINITE = 997,
    ITEM_GOLISOPITE = 998,
    ITEM_MAGEARNITE = 999,//not for player
    ITEM_SCOVILLAINITE = 1000,
    ITEM_BAXCALIBRITE = 1001,
    ITEM_TATSUGIRINITE = 1002,//not for player
    ITEM_GLIMMORANITE = 1003,

    // CUSTOM ITEMS
    ITEM_CANDY_JAR = 1004,
    ITEM_MEMORY_MUSHROOM = 1005,
    ITEM_PHIONE_EGG_CHARM = 1006,
    ITEM_ORAN_CHARM = 1007,
    ITEM_REGI_KNUCKLES_CHARM = 1008,
    ITEM_CLONING_CHARM = 1009,
    ITEM_SHINY_STARTER_CHARM = 1010,
    ITEM_LUMP_SUM_CHARM = 1011,
    ITEM_BERRY_PACK_CHARM = 1012,
    ITEM_HOOH_FEATHER_CHARM = 1013,
    ITEM_POCKET_BIRCH_BAG = 1014,
    ITEM_MINTY_CHARM = 1015,
    ITEM_TINTED_CHARM = 1016,
    ITEM_NORMAL_CHARM = 1017,
    ITEM_HP_BOTTLE_CAP = 1018,
    ITEM_ATK_BOTTLE_CAP = 1019,
    ITEM_DEF_BOTTLE_CAP = 1020,
    ITEM_SPEED_BOTTLE_CAP = 1021,
    ITEM_SPATK_BOTTLE_CAP = 1022,
